...
<body>
	<header class="cabeca">
		...
		<div class="navbar">
			...
			<ul>
				...
				<li><a href="listarCliente">Informações</a></li>
				<li><a href="listarEstatisticas">Estatísticas</a></li>	
	...
	<div class="texto">
	<p>Seja muito bem vindo ao quiosque do seu Zé, comida barata e boa.</p>
	</div>
	</section>
